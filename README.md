...
In addition, we gained knowledge about how to manipulate the IFC file and add properties to the model. In our case the script adds properties from an Excel file in [assignment 3](A3).
